...
//Empty strings for the final password, called randomlyGeneratedPassword, and the password character options
//where the random characters from within the 4 character-type strings will be added
